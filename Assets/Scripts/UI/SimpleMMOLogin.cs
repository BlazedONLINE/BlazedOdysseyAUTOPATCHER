...
public class SimpleMMOLogin : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log("🎮 SimpleMMOLogin starting...");
        CreateUI();
        Debug.Log("✅ SimpleMMOLogin ready!");
    }
    
    void CreateUI()
    {
        // Create Canvas
        GameObject canvasObj = new GameObject("Simple MMO Canvas");
